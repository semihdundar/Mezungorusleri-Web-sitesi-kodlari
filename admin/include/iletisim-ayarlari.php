      ...
      <div class="container-fluid">
       ...
       <div class="card-body card card-primary">
           ...
           <div class="col-md-12">
                <div class="form-group">
                <label>Telefon</label>
                <input type="text" class="form-control" placeholder="Telefon ..." name="telefon2" value="<?=$sitetelefon2?>">
                </div>
            </div>
             <div class="col-md-12">
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group">
                <label>E-mail</label>
                <input type="text" class="form-control" placeholder="E-mail ..." name="mail2" value="<?=$sitemail2?>">
                </div>
            </div>
             <div class="col-md-12">
                <div class="form-group">
